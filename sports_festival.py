...
def show_page():
    ...
    st.markdown("<h1 style='text-align: center; color: #1E90FF;'>🏆 2026 강화고 e-체육대회 🏆</h1>", unsafe_allow_html=True)
    ...
    st.table(df_schedule) # 깔끔한 표 형식으로 출력
    st.divider()
    # 3. 일정 (아코디언 메뉴)
