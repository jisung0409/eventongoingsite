...
.event-card { background-color: #ffffff; padding: 25px; border-radius: 15px; box-shadow: 0 4px 10px rgba(0,0,0,0.05); transition: transform 0.3s ease, box-shadow 0.3s ease; border-left: 8px solid #2196F3; margin-bottom: 15px; }
...
<p style='margin: 10px 0 5px 0; color: #3B82F6; font-size: 1.15rem; font-weight: 600;'>현재 강연 및 발표 세션 안내와 가신청이 진행 중입니다.</p>
<p style='margin: 0; color: #6B7280; font-size: 0.95rem;'>👉 진로와 관심사에 맞는 세션을 둘러보고 늦지 않게 신청서를 제출해 주세요!</p>
</div>
    """, unsafe_allow_html=True)
...
<div style="text-align: center; color: #9ca3af; font-size: 1rem; font-weight: 600;">🔜 다음 행사를 준비 중입니다</div>
</div>
        """, unsafe_allow_html=True)
